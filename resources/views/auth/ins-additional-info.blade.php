...
@section('content')
    ...
    <div class="container">
        <div class="step-content-container p-4 shadow-lg">
            <form action="{{ route('store.additional.info') }}" method="POST" id="infoForm"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="field_of_expertise" name="field_of_expertise" class="form-control">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="certifications" name="certifications" class="form-control" rows="3"></textarea>
                </div>
                <div class="mb-3">
