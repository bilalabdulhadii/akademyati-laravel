                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#selectUserModal"><i class="fa fa-user-plus me-2"></i>New User</a>
                                    <!-- Add Modal Start -->
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="d-flex justify-content-between p-3">
                                                    <h1 class="modal-title fs-5" id="selectUserLabel">New User</h1>
                                                ...
                                                @if($users->count() > 0)
                                                    @foreach($users as $user)
                                                        <tr>
                                                            ...
                                                            <td style="padding: 7px !important;">{{ ucfirst($user->role) }}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                            </tbody>
